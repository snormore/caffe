...
caffe_root = "./"
deploy_protocol = caffe_root + "models/dermnet/vgg19_train_val.prototxt"
caffe_model = caffe_root + "models/dermnet/vgg19_dermnet.caffemodel"
image_dictionary_file = caffe_root + "data/dermnet/image_dictionary.txt"
test_images_file = caffe_root + "data/dermnet/test.txt"
test_results_file = caffe_root + "data/dermnet/vgg19_outputs.txt"
